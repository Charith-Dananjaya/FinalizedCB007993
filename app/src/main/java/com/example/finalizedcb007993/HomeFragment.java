...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnSearch= view.findViewById(R.id.home_btn_search);
        txtSearch = view.findViewById(R.id.home_search_text);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new SearchFragment(keyword));
            }
        });
        ...
        cardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new ProductViewFragment("Mens Wear","Mens Wear"));
            }
        });
        cardView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new ProductViewFragment("Womens Wear","Womens Wear"));
            }
        });
        cardView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new ProductViewFragment("Kids Wear","Kids Wear"));
            }
        });
        cardView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new ProductViewFragment("Sports Wear","Sports Wear"));
            }
        });
        return view;
    }
